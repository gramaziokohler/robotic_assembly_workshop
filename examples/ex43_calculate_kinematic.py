...
response = robot.motion_plan_goal_frame(goal_frame, start_configuration, tolerance_position,
                                        tolerance_angle, group, path_constraints, num_planning_attempts=10, allowed_planning_time=10.)
